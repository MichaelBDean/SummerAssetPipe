...
//Name: WoodCar004.ma
//Last modified: Thu, May 30, 2019 02:37:57 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -49.455993670368635 38.0494108612193 -21.02143252259976 ;
	setAttr ".r" -type "double3" 330.26164704061142 -6590.1999999979535 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "78034170-4D0F-B4A6-99EB-1E8F923B07B9";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 67.430166295390023;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 5.4923889160207358 4.6013507231341695 -0.80436421975233907 ;
...
createNode transform -n "pCylinder5";
	...
	setAttr ".t" -type "double3" -7.6374337136027268 3.6105729455530167 9.8849929193567263 ;
	setAttr ".r" -type "double3" 0 0 90.000000000000028 ;
	setAttr ".s" -type "double3" 3.5974250300213111 1.1553853447902218 3.5974250300213111 ;
...
createNode transform -n "pCylinder6";
	...
	setAttr ".t" -type "double3" 7.4322605128836994 3.6105729455530167 9.8849929193567263 ;
	setAttr ".r" -type "double3" 0 0 90.000000000000028 ;
	setAttr ".s" -type "double3" 3.5974250300213111 1.1553853447902218 3.5974250300213111 ;
...
createNode transform -n "pCylinder7";
	...
	setAttr ".t" -type "double3" -0.10186155852716317 3.6133847293083523 9.8832981741527561 ;
	setAttr ".r" -type "double3" 0 0 90.000000000000028 ;
	setAttr ".s" -type "double3" 0.84294516680105924 8.8851620050597937 0.84294516680105924 ;
...
createNode mesh -n "pCubeShape6" -p "pCube6";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.71757405996322632 0 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".pt[504]" -type "float3" 0 0.071989395 0 ;
	setAttr ".pt[506]" -type "float3" 0 0.071989395 0 ;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode polyTweak -n "polyTweak48";
	...
	setAttr ".uopa" yes;
	setAttr -s 19 ".tk";
	setAttr ".tk[324]" -type "float3" 0.46926439 0 -0.0036972265 ;
	setAttr ".tk[325]" -type "float3" -1.965093e-07 0 -0.0036972265 ;
	setAttr ".tk[326]" -type "float3" -1.965093e-07 0 -0.00263596 ;
	setAttr ".tk[327]" -type "float3" 0.43133509 0 -0.00263596 ;
	setAttr ".tk[328]" -type "float3" -0.46926385 0 -0.0036972265 ;
	setAttr ".tk[329]" -type "float3" -0.43133476 0 -0.00263596 ;
	setAttr ".tk[330]" -type "float3" -0.39885724 0 -0.0017272262 ;
	setAttr ".tk[331]" -type "float3" -1.9787385e-07 0 -0.0017272262 ;
	setAttr ".tk[332]" -type "float3" 0.3988575 0 -0.0017272262 ;
	setAttr ".tk[333]" -type "float3" -0.32512856 0 0.00033572962 ;
	setAttr ".tk[334]" -type "float3" -1.9855624e-07 0 0.00033572962 ;
	setAttr ".tk[335]" -type "float3" 0.32512867 0 0.00033572962 ;
	setAttr ".tk[336]" -type "float3" -0.28878236 0 0.0013527072 ;
	setAttr ".tk[337]" -type "float3" -1.9855624e-07 0 0.0013527072 ;
	setAttr ".tk[338]" -type "float3" 0.28878242 0 0.0013527072 ;
	setAttr ".tk[339]" -type "float3" -0.20499076 0 0.0036972265 ;
	setAttr ".tk[340]" -type "float3" -1.9992098e-07 0 0.0036972265 ;
	setAttr ".tk[341]" -type "float3" 0.20499048 0 0.0036972265 ;
...
createNode polyTweak -n "polyTweak52";
	...
	setAttr ".uopa" yes;
	setAttr -s 29 ".tk";
	setAttr ".tk[350]" -type "float3" 0 -0.014639877 0 ;
	setAttr ".tk[351]" -type "float3" 0 -0.014639877 0 ;
	setAttr ".tk[352]" -type "float3" 0 -0.014639877 0 ;
	setAttr ".tk[353]" -type "float3" 0 0.0028099609 0 ;
	setAttr ".tk[354]" -type "float3" 0 0.0092308782 0 ;
	setAttr ".tk[355]" -type "float3" 0 0.0028099609 0 ;
	setAttr ".tk[356]" -type "float3" -0.014096241 0.010044664 -4.6566129e-10 ;
	setAttr ".tk[357]" -type "float3" 8.6706095e-08 0.010044663 -4.6566129e-10 ;
	setAttr ".tk[358]" -type "float3" -0.014096098 0.014409693 2.3283064e-10 ;
	setAttr ".tk[359]" -type "float3" 8.5851923e-08 0.014409691 2.3283064e-10 ;
	setAttr ".tk[360]" -type "float3" 0.014096235 0.010044664 -4.6566129e-10 ;
	setAttr ".tk[361]" -type "float3" 0.014096243 0.014409693 2.3283064e-10 ;
	setAttr ".tk[362]" -type "float3" -0.014096241 -0.020788509 0.0071827834 ;
	setAttr ".tk[363]" -type "float3" 8.6706095e-08 -0.020788509 0.0071827834 ;
	setAttr ".tk[364]" -type "float3" -0.014096098 -0.027351633 0.011781162 ;
	setAttr ".tk[365]" -type "float3" 8.5851923e-08 -0.024597183 0.011154955 ;
	setAttr ".tk[366]" -type "float3" 0.014096235 -0.020788509 0.0071827834 ;
	setAttr ".tk[367]" -type "float3" 0.014096243 -0.027351633 0.011781162 ;
	setAttr ".tk[368]" -type "float3" -0.0058873324 0.01771652 -0.0095321387 ;
	setAttr ".tk[369]" -type "float3" -0.0058872732 0.039531346 0.0025295671 ;
	setAttr ".tk[370]" -type "float3" -0.0058872732 -0.03109277 0.014928898 ;
	setAttr ".tk[371]" -type "float3" -0.0058873324 -0.013116641 -0.0025295813 ;
	setAttr ".tk[372]" -type "float3" 0.0058873408 0.01771652 -0.0095321387 ;
	setAttr ".tk[373]" -type "float3" 0.0058873361 0.039531346 0.0025295671 ;
	setAttr ".tk[374]" -type "float3" 0.0058873408 -0.013116641 -0.0025295813 ;
	setAttr ".tk[375]" -type "float3" 0.0058873361 -0.03109277 0.014928898 ;
...
createNode polyTweak -n "polyTweak54";
	...
	setAttr ".uopa" yes;
	setAttr -s 17 ".tk";
	setAttr ".tk[376]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[377]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[378]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[379]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[380]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[381]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[382]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[383]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[384]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[385]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[386]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[387]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[388]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[389]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[390]" -type "float3" 0 0 0.016890964 ;
	setAttr ".tk[391]" -type "float3" 0 0 0.016890964 ;
...
createNode polyTweak -n "polyTweak55";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[408]" -type "float3" -0.066495776 0.51747507 0.05750943 ;
	setAttr ".tk[409]" -type "float3" -3.5671093e-08 0.51747507 0.05750943 ;
	setAttr ".tk[410]" -type "float3" -0.066495776 0.59487027 0.062170491 ;
	setAttr ".tk[411]" -type "float3" -3.5671093e-08 0.59487027 0.062170491 ;
	setAttr ".tk[412]" -type "float3" 0.066495776 0.51747507 0.05750943 ;
	setAttr ".tk[413]" -type "float3" 0.066495776 0.59487027 0.062170491 ;
...
createNode polyTweak -n "polyTweak59";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[434]" -type "float3" -0.097796567 -7.4505806e-09 0 ;
	setAttr ".tk[435]" -type "float3" 0.10797106 -7.4505806e-09 0 ;
	setAttr ".tk[436]" -type "float3" -0.097796544 -7.4505806e-09 0 ;
	setAttr ".tk[437]" -type "float3" 0.072375044 -7.4505806e-09 0 ;
...
createNode polyTweak -n "polyTweak61";
	...
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk";
	setAttr ".tk[442]" -type "float3" -0.027634697 0.11227888 0 ;
	setAttr ".tk[443]" -type "float3" 0.02763468 0.11227888 0 ;
	setAttr ".tk[444]" -type "float3" -0.027634647 0.11227888 0 ;
	setAttr ".tk[445]" -type "float3" 0.027634691 0.11227888 0 ;
	setAttr ".tk[446]" -type "float3" -0.028525483 0.11227888 0 ;
	setAttr ".tk[447]" -type "float3" 0.02852549 0.11227888 0 ;
	setAttr ".tk[448]" -type "float3" -0.028525479 0.11227888 0 ;
	setAttr ".tk[449]" -type "float3" 0.028525468 0.11227888 0 ;
...
createNode polyTweak -n "polyTweak62";
	...
	setAttr ".uopa" yes;
	setAttr -s 7 ".tk";
	setAttr ".tk[450]" -type "float3" 0.12417071 0.13321815 -0.045747213 ;
	setAttr ".tk[451]" -type "float3" -6.6610305e-08 0.13321815 -0.045747213 ;
	setAttr ".tk[452]" -type "float3" -6.6610305e-08 0.13321815 0.013372906 ;
	setAttr ".tk[453]" -type "float3" 0.12417071 0.13321815 0.013372906 ;
	setAttr ".tk[454]" -type "float3" -0.12417071 0.13321815 -0.045747213 ;
	setAttr ".tk[455]" -type "float3" -0.12417071 0.13321815 0.013372906 ;
...
createNode polyTweak -n "polyTweak66";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[488]" -type "float3" 0.031476606 0 0 ;
	setAttr ".tk[489]" -type "float3" -0.031476613 0 0 ;
	setAttr ".tk[490]" -type "float3" -0.031476613 0 0 ;
	setAttr ".tk[491]" -type "float3" 0.031476606 0 0 ;
...
createNode polyTweak -n "polyTweak69";
	...
	setAttr ".uopa" yes;
	setAttr -s 50 ".tk";
	setAttr ".tk[73]" -type "float3" -1.4901161e-08 0 -1.8626451e-09 ;
	setAttr ".tk[74]" -type "float3" 7.4505806e-09 0 3.7252903e-09 ;
	setAttr ".tk[75]" -type "float3" 9.3132257e-09 0 0 ;
	...
	setAttr ".tk[79]" -type "float3" -2.7939677e-09 0 -3.7252903e-09 ;
	setAttr ".tk[80]" -type "float3" 1.8626451e-09 0 3.7252903e-09 ;
	setAttr ".tk[81]" -type "float3" 0 0 -1.8626451e-09 ;
	setAttr ".tk[82]" -type "float3" -7.4505806e-09 0 3.7252903e-09 ;
	setAttr ".tk[83]" -type "float3" 1.4901161e-08 0 -1.8626451e-09 ;
	setAttr ".tk[84]" -type "float3" 3.7252903e-09 0 0 ;
	setAttr ".tk[85]" -type "float3" 1.4901161e-08 0 2.7939677e-09 ;
	setAttr ".tk[86]" -type "float3" -7.4505806e-09 0 0 ;
	setAttr ".tk[87]" -type "float3" 0 0 1.8626451e-09 ;
	setAttr ".tk[88]" -type "float3" 5.5879354e-09 0 -3.7252903e-09 ;
	setAttr ".tk[89]" -type "float3" -1.8626451e-09 0 1.4901161e-08 ;
	...
	setAttr ".tk[95]" -type "float3" 3.7252903e-09 0 2.7939677e-09 ;
	setAttr ".tk[96]" -type "float3" -3.7252903e-09 0 0 ;
	setAttr ".tk[97]" -type "float3" -0.073809348 -0.10123766 0.019777227 ;
	setAttr ".tk[98]" -type "float3" -0.066175699 -0.10123766 0.038206622 ;
	setAttr ".tk[99]" -type "float3" 0 -0.10123766 -5.3080167e-17 ;
	setAttr ".tk[100]" -type "float3" -0.054032151 -0.10123766 0.054032207 ;
	setAttr ".tk[101]" -type "float3" -0.038206499 -0.10123766 0.066175722 ;
	setAttr ".tk[102]" -type "float3" -0.019777099 -0.10123766 0.0738094 ;
	setAttr ".tk[103]" -type "float3" 4.1667583e-08 -0.10123766 0.076413065 ;
	setAttr ".tk[104]" -type "float3" 0.019777143 -0.10123766 0.0738094 ;
	setAttr ".tk[105]" -type "float3" 0.038206533 -0.10123766 0.066175722 ;
	setAttr ".tk[106]" -type "float3" 0.054032207 -0.10123766 0.054032296 ;
	setAttr ".tk[107]" -type "float3" 0.066175699 -0.10123766 0.038206622 ;
	setAttr ".tk[108]" -type "float3" 0.073809348 -0.10123766 0.019777227 ;
	setAttr ".tk[109]" -type "float3" 0.076413065 -0.10123766 8.3335166e-08 ;
	setAttr ".tk[110]" -type "float3" 0.073809348 -0.10123766 -0.019777143 ;
	setAttr ".tk[111]" -type "float3" 0.066175699 -0.10123766 -0.038206499 ;
	setAttr ".tk[112]" -type "float3" 0.054032207 -0.10123766 -0.054032177 ;
	setAttr ".tk[113]" -type "float3" 0.038206585 -0.10123766 -0.066175602 ;
	setAttr ".tk[114]" -type "float3" 0.019777227 -0.10123766 -0.073809318 ;
	setAttr ".tk[115]" -type "float3" 4.1667583e-08 -0.10123766 -0.076413065 ;
	setAttr ".tk[116]" -type "float3" -0.019777099 -0.10123766 -0.073809318 ;
	setAttr ".tk[117]" -type "float3" -0.038206499 -0.10123766 -0.066175662 ;
	setAttr ".tk[118]" -type "float3" -0.054032207 -0.10123766 -0.054032177 ;
	setAttr ".tk[119]" -type "float3" -0.066175699 -0.10123766 -0.038206499 ;
	setAttr ".tk[120]" -type "float3" -0.0738094 -0.10123766 -0.019777143 ;
	setAttr ".tk[121]" -type "float3" -0.076413065 -0.10123766 8.3335166e-08 ;
...
createNode polyTweak -n "polyTweak71";
	...
	setAttr ".uopa" yes;
	setAttr -s 8 ".tk";
	setAttr ".tk[504]" -type "float3" 0.05555119 0.035663683 -0.023462985 ;
	setAttr ".tk[505]" -type "float3" 0.05555119 -0.00016901699 -0.023462985 ;
	setAttr ".tk[506]" -type "float3" 0.05555119 0.035663683 0.023462979 ;
	setAttr ".tk[507]" -type "float3" 0.05555119 -0.00016901699 0.023462979 ;
	setAttr ".tk[508]" -type "float3" 0.05555119 -0.035663683 -0.023462985 ;
	setAttr ".tk[509]" -type "float3" 0.05555119 -0.035663683 0.023462979 ;
...
connectAttr "polyExtrudeFace64.out" "pCylinderShape10.i";
