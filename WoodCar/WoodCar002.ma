...
//Name: WoodCar002.ma
//Last modified: Thu, May 30, 2019 12:03:59 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -35.076899509462564 16.192450258688289 61.539600558910848 ;
	setAttr ".r" -type "double3" 344.66164733055052 320.6000000000459 -2.0579891896416519e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "78034170-4D0F-B4A6-99EB-1E8F923B07B9";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 57.303793066083365;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 1.0345284723058688 18.836284204301645 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 4 ".pt[50:53]" -type "float3"  0 0 0.015344272 0 0 0.015344272 
		0 0 0.015344272 0 0 0.015344272;
	setAttr ".dr" 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace18";
	rename -uid "04AC05DD-44AD-2A17-71DC-C8B5C9F71236";
	setAttr ".ics" -type "componentList" 1 "f[2]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0 1.0345278 -23.399195 ;
	setAttr ".rs" 62659;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -6.1657562341713819 -0.048429943285522636 -23.399195209320755 ;
	setAttr ".cbx" -type "double3" 6.1657562341713819 2.1174854900065569 -23.399195209320755 ;
createNode polyTweak -n "polyTweak22";
	rename -uid "E5205DD7-4F39-8E51-85E7-EF8DB3A3F4C4";
	setAttr ".uopa" yes;
	setAttr -s 20 ".tk";
	setAttr ".tk[0]" -type "float3" -7.4505806e-09 -0.38528666 -1.8626451e-09 ;
	setAttr ".tk[1]" -type "float3" 7.4505806e-09 -0.38528666 -1.8626451e-09 ;
	setAttr ".tk[2]" -type "float3" -7.4505806e-09 2.3841858e-07 -5.5879354e-09 ;
	setAttr ".tk[3]" -type "float3" 7.4505806e-09 2.3841858e-07 -5.5879354e-09 ;
	setAttr ".tk[4]" -type "float3" -7.4505806e-09 0 0.040007994 ;
	setAttr ".tk[5]" -type "float3" 7.4505806e-09 0 0.040007994 ;
	setAttr ".tk[6]" -type "float3" -7.4505806e-09 -0.38528666 0.040007994 ;
	setAttr ".tk[7]" -type "float3" 7.4505806e-09 -0.38528666 0.040007994 ;
	setAttr ".tk[10]" -type "float3" -1.8626451e-09 0 0 ;
	setAttr ".tk[11]" -type "float3" 1.8626451e-09 0 0 ;
	setAttr ".tk[16]" -type "float3" 0 0.28942692 -0.048819136 ;
	setAttr ".tk[17]" -type "float3" 0 0.28942692 -0.048819136 ;
	setAttr ".tk[18]" -type "float3" 0.044675961 0 0.037230488 ;
	setAttr ".tk[19]" -type "float3" -0.044675961 0 0.037230488 ;
	setAttr ".tk[20]" -type "float3" 0.044675961 0 0.037230488 ;
	setAttr ".tk[21]" -type "float3" -0.044675961 0 0.037230488 ;
	setAttr ".tk[22]" -type "float3" 0 0.38155961 -0.015372107 ;
	setAttr ".tk[25]" -type "float3" 0.044675961 0 0.037230488 ;
	setAttr ".tk[26]" -type "float3" -0.044675961 0 0.037230488 ;
	setAttr ".tk[29]" -type "float3" 0 0.38155961 -0.015372107 ;
createNode polyExtrudeFace -n "polyExtrudeFace19";
	rename -uid "325817B8-40D4-A0ED-8C18-63AA10B24FEE";
	setAttr ".ics" -type "componentList" 1 "f[2]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	...
	setAttr ".rs" 52647;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -7.3952307881855264 -0.2168899383133851 -23.399195209320755 ;
	setAttr ".cbx" -type "double3" 7.3952307881855264 2.2859455782271327 -23.399195209320755 ;
createNode polyTweak -n "polyTweak23";
	rename -uid "33D3E6E6-4C4C-514A-EEE5-2F870173634A";
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[30:33]" -type "float3"  -0.099701881 0.10774453 0
		 0.099701881 0.10774453 0 0.099701881 -0.10774453 0 -0.099701881 -0.10774453 0;
createNode polyExtrudeFace -n "polyExtrudeFace20";
	rename -uid "2155DBA8-4CBE-6E64-7223-DDB03D717D29";
	setAttr ".ics" -type "componentList" 1 "f[0]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0 1.0345281 18.570066 ;
	setAttr ".rs" 42922;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -6.1657562341713819 -0.048429756900095544 18.570066136483806 ;
	setAttr ".cbx" -type "double3" 6.1657562341713819 2.1174860491628382 18.570066136483806 ;
createNode polyTweak -n "polyTweak24";
	rename -uid "92EDB9A4-4ED9-CB40-9A8D-529945EFD9A7";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[34]" -type "float3" 0 0 -0.01440856 ;
	setAttr ".tk[35]" -type "float3" 0 0 -0.01440856 ;
	setAttr ".tk[36]" -type "float3" 0 0 -0.01440856 ;
	setAttr ".tk[37]" -type "float3" 0 0 -0.01440856 ;
createNode polyExtrudeFace -n "polyExtrudeFace21";
	rename -uid "8C6BD86E-416A-9008-85C1-C3994F999711";
	setAttr ".ics" -type "componentList" 1 "f[0]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0 1.0345285 18.570066 ;
	setAttr ".rs" 48587;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -5.7919620708520236 0.25851405130167082 18.570066136483806 ;
	setAttr ".cbx" -type "double3" 5.7919620708520236 1.8105428933100667 18.570066136483806 ;
createNode polyTweak -n "polyTweak25";
	rename -uid "AD623FFD-48DD-E9DF-52C5-1BB1B6E266A5";
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[38:41]" -type "float3"  0.03031213 0.19631657 0 -0.03031213
		 0.19631657 0 -0.03031213 -0.19631617 0 0.03031213 -0.19631617 0;
createNode polyExtrudeFace -n "polyExtrudeFace22";
	rename -uid "29FEF8BD-45D1-49BD-7BA8-C48596B757AC";
	setAttr ".ics" -type "componentList" 1 "f[0]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0 1.0345286 18.733831 ;
	setAttr ".rs" 39969;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -5.7919613358368665 0.25851414449438437 18.733830825759867 ;
	setAttr ".cbx" -type "double3" 5.7919613358368665 1.8105429865027802 18.733830825759867 ;
createNode polyTweak -n "polyTweak26";
	rename -uid "FF8AD523-4A2F-55F7-B89D-478ECB3FE38C";
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[42:45]" -type "float3"  0 0 0.0044093528 0 0 0.0044093528
		 0 0 0.0044093528 0 0 0.0044093528;
createNode polyExtrudeFace -n "polyExtrudeFace23";
	rename -uid "33FD8593-42A0-9748-D95B-D9B913803A06";
	setAttr ".ics" -type "componentList" 1 "f[0]";
	setAttr ".ix" -type "matrix" 12.331508058251819 0 0 0 0 1.563514284796728 0 0 0 0 37.140132272967612 0
		 0 1.3357282544154794 0 1;
	setAttr ".ws" yes;
	...
	setAttr ".rs" 56191;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -7.4608323610099507 -0.21118244376493966 18.733830825759867 ;
	setAttr ".cbx" -type "double3" 7.4608323610099507 2.2802397611475316 18.733830825759867 ;
createNode polyTweak -n "polyTweak27";
	rename -uid "7C03867B-472C-CED3-F10D-6F943C4AEE3D";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[46]" -type "float3" -0.13533394 -0.30041084 0 ;
	setAttr ".tk[47]" -type "float3" 0.13533394 -0.30041084 0 ;
	setAttr ".tk[48]" -type "float3" 0.13533394 0.30041084 0 ;
	setAttr ".tk[49]" -type "float3" -0.13533394 0.30041084 0 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
